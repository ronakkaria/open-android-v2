...
public class PrepaidWallet extends Activity {
	...
	private void init() {
		...
		getprepaidbill.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				.execute(new String[]{"10", "http://yourwebsite.com/returnurl.php"});
			}
		});
		...
		card_load.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Card card = new Card("4111111111111111", "04", "19", "078", "Tester Shardul", "debit");
	...
	private void initconfig() {
        ...
        Config.setSigninId("tabcab-prepaid-payment");
        Config.setSigninSecret("029519298299e38fa2da5ecd6d83d7e0");
	}
